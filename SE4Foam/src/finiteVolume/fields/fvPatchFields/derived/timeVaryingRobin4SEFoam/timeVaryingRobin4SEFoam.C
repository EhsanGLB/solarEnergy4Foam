...
#include "timeVaryingRobin4SEFoam.H"
...
Foam::timeVaryingRobin4SEFoam::timeVaryingRobin4SEFoam
(
    const fvPatch& p,
...
Foam::timeVaryingRobin4SEFoam::timeVaryingRobin4SEFoam
(
    const timeVaryingRobin4SEFoam& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::timeVaryingRobin4SEFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::timeVaryingRobin4SEFoam::write(Ostream& os) const
{
