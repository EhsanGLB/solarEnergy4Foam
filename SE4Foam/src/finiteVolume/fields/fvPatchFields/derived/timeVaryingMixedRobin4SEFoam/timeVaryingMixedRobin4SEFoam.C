...
#include "timeVaryingMixedRobin4SEFoam.H"
...
Foam::timeVaryingMixedRobin4SEFoam::timeVaryingMixedRobin4SEFoam
(
    const fvPatch& p,
...
Foam::timeVaryingMixedRobin4SEFoam::timeVaryingMixedRobin4SEFoam
(
    const timeVaryingMixedRobin4SEFoam& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::timeVaryingMixedRobin4SEFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::timeVaryingMixedRobin4SEFoam::write(Ostream& os) const
{
