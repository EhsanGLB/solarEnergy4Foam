...
#include "powerLawRadialVelocity4SEFoam.H"
...
powerLawRadialVelocity4SEFoam::powerLawRadialVelocity4SEFoam
(
    const fvPatch& p,
...
powerLawRadialVelocity4SEFoam::powerLawRadialVelocity4SEFoam
(
    const powerLawRadialVelocity4SEFoam& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
powerLawRadialVelocity4SEFoam::powerLawRadialVelocity4SEFoam
(
    const powerLawRadialVelocity4SEFoam& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
Foam::scalar Foam::powerLawRadialVelocity4SEFoam::VmFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
void powerLawRadialVelocity4SEFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void powerLawRadialVelocity4SEFoam::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, powerLawRadialVelocity4SEFoam);
