...
#include "parabolicRadialVelocity4SEFoam.H"
...
parabolicRadialVelocity4SEFoam::parabolicRadialVelocity4SEFoam
(
    const fvPatch& p,
...
parabolicRadialVelocity4SEFoam::parabolicRadialVelocity4SEFoam
(
    const parabolicRadialVelocity4SEFoam& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
parabolicRadialVelocity4SEFoam::parabolicRadialVelocity4SEFoam
(
    const parabolicRadialVelocity4SEFoam& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
Foam::scalar Foam::parabolicRadialVelocity4SEFoam::VmFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
void parabolicRadialVelocity4SEFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void parabolicRadialVelocity4SEFoam::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, parabolicRadialVelocity4SEFoam);
