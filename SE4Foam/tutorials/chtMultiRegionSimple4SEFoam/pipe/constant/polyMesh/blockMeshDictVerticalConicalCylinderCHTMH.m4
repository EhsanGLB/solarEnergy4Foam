...
m4_define(intCyRB, 38.0)
m4_define(intCyRT, 38.0)
m4_define(intCyH, 1000.0)


//dimensions of external cylinder
m4_define(extCyRB, 42.0)
m4_define(extCyRT, 42.0)
m4_define(extCyH, 1000.0)

m4_define(extCyRN, 20)
m4_define(extCyHN, 50)
...
(
  ...
  //-Internal cylinder
    hex (intSqB0 intSqB3 intSqT3 intSqT0 intCyB0 intCyB3 intCyT3 intCyT0) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 0.1)
    hex (intSqB3 intSqB2 intSqT2 intSqT3 intCyB3 intCyB2 intCyT2 intCyT3) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 0.1)
    hex (intSqB2 intSqB1 intSqT1 intSqT2 intCyB2 intCyB1 intCyT1 intCyT2) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 0.1)
    hex (intSqB1 intSqB0 intSqT0 intSqT1 intCyB1 intCyB0 intCyT0 intCyT1) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 0.1)
