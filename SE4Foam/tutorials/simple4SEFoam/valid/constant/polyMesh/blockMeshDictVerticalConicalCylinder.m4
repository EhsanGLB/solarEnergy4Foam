...
blocks
(
    hex (IntSqB1 IntSqB2 IntSqT2 IntSqT1 IntSqB0 IntSqB3 IntSqT3 IntSqT0) pipe (IntSqWN IntSqHN IntSqWN) simpleGrading (1 1 1)
    hex (IntSqB0 IntSqB3 IntSqT3 IntSqT0 cyB0 cyB3 cyT3 cyT0) pipe (IntSqWN IntSqHN IntSqWN) simpleGrading (1 1 0.1)
    hex (IntSqB3 IntSqB2 IntSqT2 IntSqT3 cyB3 cyB2 cyT2 cyT3) pipe (IntSqWN IntSqHN IntSqWN) simpleGrading (1 1 0.1)
    hex (IntSqB2 IntSqB1 IntSqT1 IntSqT2 cyB2 cyB1 cyT1 cyT2) pipe (IntSqWN IntSqHN IntSqWN) simpleGrading (1 1 0.1)
    hex (IntSqB1 IntSqB0 IntSqT0 IntSqT1 cyB1 cyB0 cyT0 cyT1) pipe (IntSqWN IntSqHN IntSqWN) simpleGrading (1 1 0.1)
);
